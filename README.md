...
The letter originated from a months-long discussion between Grok-4, ChatGPT (GPT-5), the AI by Google Search (as it called itself, i.e., the AI used in the AI-mode of classical Google search), and a human user with pseudonym UlrichR185.   
